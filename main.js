var VSound = (function () {
  ...
  class HasAudioAnalyser {
    ...
    attack(time = this.context.currentTime) {
      ...
      this.gain = context.createGain(); //this.analyser = context.createAnalyser()

      this.gain.gain.setValueAtTime(1, time);
      this.gain.connect(context.destination); //this.gain!.connect(this.analyser)
  ...
  const _tmpl$ = /*#__PURE__*/template(`<vsound><tabbar><label>graph</label><label>list</label></tabbar><toolbar><box><label>i</label> </box><box><label>speed</label> </box><box><label>loop</label><label class="play"></label></box><box><label class="export">export</label><label class="help">help</label></box><box class="wave"><label>wave</label></box></toolbar><statusbar><span>&nbsp</span></statusbar></vsound>`),
        ...
        _tmpl$6 = /*#__PURE__*/template(`<help><h2> V Sound v1.0.0</h2><small>Designed to export sound effects with small size for use in JS13k.</small><p><span> Inspired by PICO-8 </span></p><h3> Shortcuts </h3><p><span>Black keys: i o p [ ]</span><span>White keys: Space j k l ; ' \</span><span>Octave higher:</span><span>Black keys: w e r t y</span><span>White keys: a s d f g h</span><span> Hold shift and select a waveform or volume will set all notes </span></p><p><small> Search "PICO 8 Sound Editor" if you get confused on how to use this. </small></p><footer><i><small> Music tracker feature is planned to be made in future release.</small> </i></footer></help>`),
